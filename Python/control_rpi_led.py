...
ENDPOINT = "a221a6r4ojicsi-ats.iot.ap-southeast-1.amazonaws.com"

# LED PINs
# TODO: Change pins [if required]
LED_PIN_1 = 14 # 11 R but B
LED_PIN_2 = 15 # 13 G but G
LED_PIN_3 = 18 # 15 B but R

# Temperature and humidity sensor
DHT_PIN = 10

# Device ids
LED_ID = "device166.389"

TEMP_ID = "device167.390"
HUMID_ID = "device167.391"
...
def publish_continuously(interval, mqtt_client):
	while True:
...
def get_led_values():
	if not GPIO.input(LED_PIN_1):
		led = "BLUE"
	elif not GPIO.input(LED_PIN_2):
		led = "GREEN"
	elif not GPIO.input(LED_PIN_3):
		led = "RED"
	else:
		led = "OFF"
	return led 
