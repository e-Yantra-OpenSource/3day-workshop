...
#define MGOS_CONFIG_HAVE_APP_INTERVAL
int         mgos_config_get_app_interval(struct mgos_config *cfg);
...
void mgos_config_set_app_interval(struct mgos_config *cfg, int         val);
/* }}} */
...
#define MGOS_SYS_CONFIG_HAVE_APP_INTERVAL
static inline int         mgos_sys_config_get_app_interval(void) { return mgos_config_get_app_interval(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_app_interval(int         val) { mgos_config_set_app_interval(&mgos_sys_config, val); }
